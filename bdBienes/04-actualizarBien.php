<?php
	...
	if(isset($_SESSION['usuario'])){		
		...
		if($codigo==6){
			if($md==1||!$md){
				//Si $md ==1, es porque viene de la confirmación de edición del campo detalles de bienes.
				//Si $md no existe, es porque viene de los demás campos.
				...
				//Si $md ==2, viene del rechazo de la edición del campo detalles de bienes.
