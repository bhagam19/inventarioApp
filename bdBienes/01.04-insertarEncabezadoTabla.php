					...
					<table class="tablaBD tablaBienes" border=1>
						<thead>								
							...
							if(!isset($_SESSION['usuario'])){
								echo '										
									<td class="img sticky1" style="width:60px">----</td>
									<td class="img sticky2" style="width:60px">----</td>
								';						
							}else{
								...
								echo'										
									<th colspan="2" class="sticky1"><img style="width:45px;height:20px;z-index:99;" title ="Agregar un bien." src="../art/agregar.svg" onclick="mostrarEdicionBienes(event,\''.$queryUrl.'\',1,'.$codBien.',\''.$u.'\',\''.$uID.'\',\''.$uP.'\')"/></th>
								';		
							}
							echo'
								<th style="width:40px" class="encabezadoTabla sticky3">COD.<img class="imgOrden" src="../art/ordenarAZ.svg" onclick="ordenarBien(\''.$queryUrl.'\',0,\'codBien\')"/><img class="imgOrden" src="../art/ordenarZA.svg" onclick="ordenarBien(\''.$queryUrl.'\',1,\'codBien\')"/></th>
								<th style="width:100px" class="encabezadoTabla sticky4">BIEN ASIGNADO <img class="imgOrden" src="../art/ordenarAZ.svg" onclick="ordenarBien(\''.$queryUrl.'\',0,\'nomBien\')"/><img class="imgOrden" src="../art/ordenarZA.svg" onclick="ordenarBien(\''.$queryUrl.'\',1,\'nomBien\')"/></th>
								<th style="width:120px" class="encabezadoTabla sticky5">DETALLE DEL BIEN ASIGNADO <img class="imgOrden" src="../art/ordenarAZ.svg" onclick="ordenarBien(\''.$queryUrl.'\',0,\'detalleDelBien\')"/><img class="imgOrden" src="../art/ordenarZA.svg" onclick="ordenarBien(\''.$queryUrl.'\',1,\'detalleDelBien\')"/></th>
								<th style="width:50px" class="encabezadoTabla sticky6">CANT <img class="imgOrden" src="../art/ordenarAZ.svg" onclick="ordenarBien(\''.$queryUrl.'\',0,\'cantBien\')"/><img class="imgOrden" src="../art/ordenarZA.svg" onclick="ordenarBien(\''.$queryUrl.'\',1,\'cantBien\')"/></th>
								<th style="width:90px" class="encabezadoTabla sticky7">ESTADO<img class="imgOrden" src="../art/ordenarAZ.svg" onclick="ordenarBien(\''.$queryUrl.'\',0,\'codEstado\')"/><img class="imgOrden" src="../art/ordenarZA.svg" onclick="ordenarBien(\''.$queryUrl.'\',1,\'codEstado\')"/></th>
