	...
	$salida.= 
				'	
					<tr class="filaFiltros stickyHead2">		
						<th class="img sticky1" colspan="3" style="text-align:right;background:white;font-weight:bolder">Filtrar: ======></th>	
						<th class="encabezadoTabla sticky4" style="text-align:left">';
							if($f1==""||$f1=="por Bien..."){
								$salida.='
								<select style="';
							}else{
						...
						<td class="encabezadoTabla sticky5">';							
						...
						<td class="encabezadoTabla sticky6"></td>
						<th class="encabezadoTabla sticky7">';
							if($f9==""||$f9=="por Estado..."){
								$salida.='
								<select style="';
							}else{
